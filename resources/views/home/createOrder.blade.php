...
@section('content')
<section class="rr-order-now py-5">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <div class="start-content">
                                <h3>Laptop retrieval service</h3>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="tel" {{ Auth::check() ? Auth::user()->phone : '' }} class="form-control required" minlength="13" id="single_user_phone" aria-describedby="single_user_phone" name="single_user_phone" placeholder="Phone Number" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="input-group mb-3">
                                            <select class="form-select required" name="type_of_equipment" id="type_of_equipment" required>
                                                ...
                                                <option value="Laptop">Laptop - ${{$priceSettings[0]->order_amount}}</option>
                                                <option value="Monitor">Monitor - ${{$priceSettings[1]->order_amount}}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                        ...
                        <div class="col-md-11">
                            <div class="start-content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-4 col-12">
                                        <select name="employee_state" id="employee_state" class="form-select required2" required="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-11">
                            <div class="start-content">
                                ...
                                <div class="row mt-4">
                                    <div class="col-6 text-start">
                                        <a class="btn btn-lg theme-bgcolor-btn-two text-white step-new-employee-back"><span class="me-2"><svg width="14" height="16" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M6.00887 12.151L0.503677 6.59567L0.508481 5.53502L6.06378 0.0297646L7.11962 1.09526L2.85045 5.32595L13.7896 5.37551L13.7828 6.87549L2.84366 6.82594L7.07432 11.0951L6.00887 12.151Z" fill="white"/></svg></span>Previous</a>
                                    </div>
                                    <div class="col-6 text-end">
                                        <a class="btn btn-lg theme-bgblack-color text-white step-new-employee-next">Next <span class="ms-2"><svg width="14" height="16" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M8 0.034668L13.5303 5.565V6.62566L8 12.156L6.93934 11.0953L11.1893 6.84533H0.25V5.34533H11.1893L6.93934 1.09533L8 0.034668Z" fill="white"></path></svg></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-7">
                            <div class="start-content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-4 col-12">
                                        <select name="recipient_state" id="recipient_state" class="form-select required3" required="">
                                             @include('includes.states_options')
                                        </select>
                                    </div>
                                    <div class="mb-3 col-md-4 col-12">
                        ...
                        <div class="col-md-4">
                            <div class="end-content">
                                ...
                                <div class="row mt-4 mobile-place-order-btn">
                                    <div class="col-6 text-start">
                                        <a class="btn btn-dark text-white step-three-back"><span class="me-2"><svg width="14" height="16" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M6.00887 12.151L0.503677 6.59567L0.508481 5.53502L6.06378 0.0297646L7.11962 1.09526L2.85045 5.32595L13.7896 5.37551L13.7828 6.87549L2.84366 6.82594L7.07432 11.0951L6.00887 12.151Z" fill="white"/></svg></span>Previous</a>
                                    </div>
                                    <div class="col-6 text-end">
                                        <button type="submit" class="btn btn-dark step-submit">Place Order <span class="ms-2"><svg width="14" height="16" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M8 0.034668L13.5303 5.565V6.62566L8 12.156L6.93934 11.0953L11.1893 6.84533H0.25V5.34533H11.1893L6.93934 1.09533L8 0.034668Z" fill="white"></path></svg></span></button>
                                    </div>
                                </div>
                            </div>
                        </div>
